package de.htwsaar.dfs.ios_bootstrap.clients;
...
public class UploadImageTestClient {
 

    // URL for the request
    private static String uploadHttpURL = "http://localhost:8080/ios_bootstrap/rest/images/upload";
    //File to upload
    private static File filePath = new File("C:/Users/Aude/Desktop/ford.png"); 
    
    public static void main(String []args) throws Exception {
 
        // invoke file upload service using above parameters
        String responseString = testUploadService(uploadHttpURL, filePath);
