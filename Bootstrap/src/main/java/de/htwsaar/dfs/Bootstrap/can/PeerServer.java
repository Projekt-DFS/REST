...
public class PeerServer {
	...
	public static void main(String [] args ) throws IOException, InterruptedException 
	    ...
	    *    
	    */
	//	testPeer.createRoutingTable(testPeer.ipToLong("192.168.2.110"), zoneB);
		//testPeer.createRoutingTable(testPeer.ipToLong("192.168.2.111"), zoneC);
	    
		String baseUrl ="http://"+ testPeer.getIpAdress()+":"+Peer.port;
